...
const AddContent = () => {
  ...
  //     const allContents = response.data.associates;
  //     getContents(allContents);
  //     // setLoading(false);
  //   //   menu = allContents.map((associate)=>{
  ...
  //   }
  // };
  // const getRolesWithContentId = associateId => {
  //   // setRoles([]);
  //   axios
  //     .get(CONSTANTS.BASE_URL + 'api/role', {
      ...
      <Container maxWidth="md">
        <Formik
          ...
          onSubmit={values => {
            ...
            axios
              .post(CONSTANTS.BASE_URL + 'api/content', data)
              .then(response => {
